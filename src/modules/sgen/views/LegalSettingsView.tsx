      ...
      <div className="flex items-start gap-4">
        ...
        <div className="space-y-3 flex-1">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 text-xs text-amber-800">
            VersaEnergy organiza evidencia, responsabilidades, acciones y revisiones para operar mejor la energia.
            La organizacion conserva la responsabilidad de sus compromisos externos, auditorias, criterios internos y decisiones formales.
            La funcionalidad SGEn describe preparacion operativa y cobertura del sistema de gestion energetica.
          </div>
          {!acknowledged ? (
